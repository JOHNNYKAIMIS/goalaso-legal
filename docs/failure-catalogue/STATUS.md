...
| G05 | [Το ζωντανό site αποκλίνει από το main](G05-live-diverges-from-main.md) | **ΦΥΛΑΣΣΕΤΑΙ** | `node scripts/deploy-check.mjs` → ✓ deploy:check — 3/3 αρχεία του origin/main @ 30421cc ταυτίζονται byte-προς-byte με https://johnnykaimis.github.io/goalaso-legal/ (index.html 603 B, privacy.html 8104 B, terms.html 5941 B) — δοκιμή 1, 0.2 s, χωρίς CDN cache | `node scripts/deploy-prove.mjs` → ✓ deploy:prove — 4/4 μεταλλάξεις κόκκινες, 4/4 αθώες πράσινες, fail-closed 3/3 |
